...
class Resistance:
    ...
    def finding_color_code(self):
        while True:
            ...
            if a.isdigit():
                c1 = int(a[0])
                c2 = 0 if len(a) == 1 else int(a[1])
                c3 = int(len(a) - 2) if len(a) > 2 else 0
                ...
                if c3 > 9:
                    ...
                    print(
                        "The color code is ",
                        self.color_finder[c1],
                        "|",
                        self.color_finder[c2],
                        "|",
    ...
    def finding_resistance(self):
        while True:
            ...
            if (
                a in self.color_finder
                and b in self.color_finder
                and c in self.color_finder
            ):
